...
static const uint8_t LUT_SIZE_WS2IN9V2 = 159;
static const uint8_t ACTUAL_LUT_SIZE_WS2IN9V2 = 153;

static const uint8_t FULL_UPDATE_LUT_WS2IN9V2[LUT_SIZE_WS2IN9V2] = {
...
0x22, 0x17, 0x41, 0x0,  0x32, 0x36  // These are not really part of the LUT
};

static const uint8_t PARTIAL_UPDATE_LUT_WS2IN9V2[LUT_SIZE_WS2IN9V2] = {
...
0x22,0x17,0x41,0xB0,0x32,0x36,  // These are not really part of the LUT
};
...
void HOT WaveshareEPaperTypeA::display() {
  ...
  if (this->full_update_every_ >= 1) {
    if (full_update != prev_full_update || this->model_ == WAVESHARE_EPAPER_2_9_IN_V2) {
      switch (this->model_) {
        case TTGO_EPAPER_2_13_IN:
        ...
        case WAVESHARE_EPAPER_2_9_IN_V2:
          {
            ...
            if (full_update)
            {
              this->write_lut_(FULL_UPDATE_LUT_WS2IN9V2, ACTUAL_LUT_SIZE_WS2IN9V2);
              extra = &FULL_UPDATE_LUT_WS2IN9V2[ACTUAL_LUT_SIZE_WS2IN9V2];
            }
            else
            {
              this->write_lut_(PARTIAL_UPDATE_LUT_WS2IN9V2, ACTUAL_LUT_SIZE_WS2IN9V2);
              extra = &PARTIAL_UPDATE_LUT_WS2IN9V2[ACTUAL_LUT_SIZE_WS2IN9V2];
            }
            this->wait_until_idle_();
  ...
  switch (this->model_) {
    case WAVESHARE_EPAPER_2_9_IN_V2:
      this->data(full_update ? 0xC7 : 0x0F);
      break;
    case WAVESHARE_EPAPER_1_54_IN_V2:
    case TTGO_EPAPER_2_13_IN_B74:
